...
const erkek = message.guild.roles.cache.find(r => r.id === "816330827931713566")
const xy = message.guild.roles.cache.find(r => r.id === "817133124689461278")
const kayıtsız = message.guild.roles.cache.find(r => r.id === "816333872152707173")
const reglog = message.guild.channels.cache.find(c => c.id === "816356681919365140")
const genelchat = message.guild.channels.cache.find(g => g.id === "816359369439969301")
